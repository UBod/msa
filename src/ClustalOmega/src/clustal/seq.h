...
/*
 *  RCS $Id: seq.h 283 2013-06-10 17:42:14Z fabian $
 */
...
extern int
WriteAlignment(mseq_t *mseq, const char *aln_outfile, int msafile_format, int iWrap, bool bResno, int *result_c, char ***result_v);
